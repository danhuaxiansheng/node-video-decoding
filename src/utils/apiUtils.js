class ApiUtils {
  ...
  getParams(url) {
    ...
    let p = (m.getDate() + 9 + 9) ^ 10;
    p = this.getF(p + "").substring(0, 10);
    p = this.getF(p);
    ...
    function f(e, t) {
      ...
      for (n = 0; n < e.length; n += 16)
        (r = d),
          ...
          (d = u(
            d,
            (p = a(p, m, h, d, e[n + 15], 22, 1236535329)),
            m,
            h,
            e[n + 1],
            5,
          ...
          (d = c(
            d,
            (p = u(p, m, h, d, e[n + 12], 20, -1926607734)),
            m,
            h,
            e[n + 5],
            4,
          ...
          (d = s(
            d,
            (p = c(p, m, h, d, e[n + 2], 23, -995338651)),
            m,
            h,
            e[n],
            6,
    ...
    function y(e, t) {
      return (function (e, t) {
        ...
        for (
          ...
          (i[n] = 909522486 ^ o[n]), (l[n] = 1549556828 ^ o[n]);
        return (
          (r = f(i.concat(p(t)), 512 + 8 * t.length)), d(f(l.concat(r), 640))
        );
      })(h(e), h(t));
    }
    function g(e, t, n) {
